...
function selectCity(id1, id2, id3) {
    ...
    var accountBankAddress = loca2 + "-" + loca4;
    
    if(accountBankAddress == "请选择...-请选择..."){
    	
    	document.getElementById(id3).value = "";
    	
    }else{
    	
    	document.getElementById(id3).value = accountBankAddress ;
    	
    }
}
function initCity(id1, id2) {
    with(document.getElementById(id1)) {
        length = where.length;
