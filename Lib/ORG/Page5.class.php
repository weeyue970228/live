...
class Page {
    ...
    public function show() {
        ...
        if ($upRow>0){
           ...
           // $upPage="<a  class=\"page-prev-dis\" href=\"javascript:void(0)\" >上一页</a>";
            $upPage="";
        }
        ...
        $pageStr	 =	 str_replace(
			...
			array('%first%','%upPage%','%linkPage%','%downPage%','%end%'),
            array($theFirst,$upPage,$linkPage,$downPage,$theEnd),$this->config['theme']);
        return $pageStr;
    }
